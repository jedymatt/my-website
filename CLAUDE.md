...
- `src/lib/` — Utilities (`github.ts` for API fetching), static data (`projects.ts`), and TypeScript interfaces (`types.ts`)
...
- Card noise overlay uses an inline SVG fractal noise filter
